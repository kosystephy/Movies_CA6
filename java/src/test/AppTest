...
public class AppTest {
	...
	public void testFindAllMovie() throws DaoException {
		...
		expectedMovies.add(new Artist(1, "Movie1", "Producer1", "2009-12-10","type1","Genre1", "01:58:12" 4.5));
		expectedMovies.add(new Artist(2, "Movie2", "Producer2",  "2010-11-11","type2","Genre2","02:50:12", 4.0));
		expectedMovies.add(new Artist(3, "Movie3", "Producer3", "2013-04-05", "type3","Genre3", "01:58:00", 3.5));
...
//                           "";
	...
	public void testFindMovieById() throws DaoException {
		...
		String expected = "Movie{id=1, title='Title1', producer='Producer1', release_date='2009-12-10',type='type1',genre='genre1', duration='01:58:12', rating=4.5}";
	...
	public void testFilterMoviesByRating() throws DaoException {
		...
		List<Movie> movieExpected = new ArrayList<>();
		expectedMovies.add(new Artist(1, "Movie1", "Producer1", "2009-12-10","type1","Genre1", "01:58:12" 4.5));
		expectedMovies.add(new Artist(2, "Movie2", "Producer2",  "2010-11-11","type2","Genre2","02:50:12", 4.0));
		expectedMovies.add(new Artist(3, "Movie3", "Producer3", "2013-04-05", "type3","Genre3", "01:58:00", 3.5));
	...
	public void testFindAllMoviesJson() throws DaoException {
		String expected = "Movie{id=1, title='Title1', producer='Producer1', release_date='2009-12-10',type='type1',genre='genre1', duration='01:58:12', rating=4.5}"+
				"Movie{id=2, title='Title2', producer='Producer2', release_date='2010-11-11',type='type2',genre='genre2', duration='02:50:12', rating=4.0}" +
				"Movie{id=3, title='Title3', producer='Producer3', release_date='2013-04-05',type='type3',genre='genre3', duration='01:58:00', rating=3.5}" +
				"";
